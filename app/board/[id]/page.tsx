                ...
                <section className={style.container_content_left}>
                        ...
                        <section className={style.container_content_left_top}>
                            <div className={style.profile}>
                                {isLoading ? (
                                    ...
                                    <Profile img={getItem?.member.img} />
                                ) : (
                                    <Profile text={getLastName(getItem?.member.nickname as string)} />
                                )}
                    ...
                    <section className={style.container_content_left_bottom}>
                        <section className={style.chat_box}>
                            <div className={style.chat}>
                                {getComment.map((item) => {
                                    ...
                                    return item.memberId.id === member.id ? (
                                        <ul key={item.id} className={style.my_chat}>
                                            <li ref={commentRef}>
                                                <div>
                            ...
                            {year}
                                        ...
                                        <ul key={item.id} className={style.other_chat}>
                                            <li ref={commentRef}>
                                                {item.memberId.img ? (
                                                    <div className={style.user}>
                        ...
                        <div className={style.button_container}>
                            <Input
                                typeStyle={member.id ? 'send' : 'not_send'}
                                type={'text'}
                                ref={inputRef}
                                disabled={!member.id}
                            ...
                            />
                            {isSendLoading ? (
                                <div className={style.loading_btn}>
